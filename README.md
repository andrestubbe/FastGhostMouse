...
dependencies {
    implementation 'io.github.andrestubbe:fastghostmouse:0.1.0'
...
1.  📦 **[fastghostmouse-v0.1.0.jar](https://github.com/andrestubbe/fastghostmouse/releases)** (The Core Library)
