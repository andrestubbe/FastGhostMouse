# FastGhostMouse 0.1.0 [ALPHA-2026-05-17] — High-Performance Native Overlay Cursor for Java
...
[![JitPack](https://img.shields.io/badge/JitPack-ready-green.svg)](https://jitpack.io/#andrestubbe/FastGhostMouse)
...
1. 📦 **[fastghostmouse-0.1.0.jar](https://github.com/andrestubbe/FastGhostMouse/releases/download/0.1.0/fastghostmouse-0.1.0.jar)** (The Core Library)
